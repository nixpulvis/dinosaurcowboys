Rails.application.configure do
  ...
  # Fuck you New Relic, why are you breaking ETag generation.
  # http://stackoverflow.com/questions/18453435/newrelic-causing-newer-etags-to-be-generated-on-each-request
